...
namespace AgentIsland.Providers.Cost.Grok;
...
/// carries costUsdTicks (USD * 1e-9, verified 158652000 ticks = $0.159),
...
public static class GrokLogParser
{
    private const string FallbackModel = "grok";

    public static List<(TokenEvent Event, string? DedupKey)> ParseFile(string path)
    {
